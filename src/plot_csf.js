...
function compdist(fn,ind){
	...
	script.onload = function () {
		...
		document.getElementById('track'+ind + "t").innerHTML = fips_dict[fn.slice(0,2)].toUpperCase() + "-" + (fn.slice(2,4) == "00" ? "AL":parseInt(fn.slice(2,4)));
		document.getElementById('distlabel'+ind).innerHTML = fips_dict[fn.slice(0,2)].toUpperCase() + "-" + (fn.slice(2,4) == "00" ? "AL":parseInt(fn.slice(2,4)));
